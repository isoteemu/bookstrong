...
def scrape_matches(wrestler_nr, match_offset=0):
    ...
    c_file = 'cache/matches-%d-%d.txt' % (wrestler_nr, match_offset)
...
if __name__ == '__main__':
	...
	workers = session.query(Wrestler).filter(Wrestler.nr.in_([14988,401,15517,4411,5724,2472,6093,1489,1781,9679]))
